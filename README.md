...
This is a fork of [etckeeper](https://etckeeper.branchable.com/) by Joey Hess.
The original source is developed at
<https://git.joeyh.name/git/etckeeper.git>.
...
[`GPL`](GPL) file). This fork is distributed unchanged under the same
license.
